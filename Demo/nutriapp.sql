...
-- Tiempo de generación: 10-04-2026 a las 08:01:49
...
--
-- Estructura de tabla para la tabla `t-0`
--

DROP TABLE IF EXISTS `t-0`;
CREATE TABLE IF NOT EXISTS `t-0` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `alimento` varchar(25) DEFAULT NULL,
...
--
-- Estructura de tabla para la tabla `t-1`
--

DROP TABLE IF EXISTS `t-1`;
CREATE TABLE IF NOT EXISTS `t-1` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `alimento` varchar(25) DEFAULT NULL,
  `na_100` decimal(10,2) DEFAULT NULL,
  `ca_100` decimal(10,2) DEFAULT NULL,
...
--
-- Estructura de tabla para la tabla `t-3`
--

DROP TABLE IF EXISTS `t-3`;
CREATE TABLE IF NOT EXISTS `t-3` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `alimento` varchar(25) DEFAULT NULL,
  `na_100` decimal(10,2) DEFAULT NULL,
  `ca_100` decimal(10,2) DEFAULT NULL,
...
--
-- Volcado de datos para la tabla `t-3`
--

INSERT INTO `t-3` (`id`, `alimento`, `na_100`, `ca_100`, `k_100`, `energia_kcal`, `proteinas_g`, `grasas_g`, `ags_g`, `agm_g`, `agp_g`, `colesterol_mg`, `hc_g`, `fibra_g`, `vit_c_mg`, `vit_b6_mg`, `vit_e_mg`, `hierro_mg`, `sodio_mg`, `calcio_mg`, `potasio_mg`, `porcentaje_energia_total`) VALUES
(1, '1', '1.00', '1.00', '1.00', '1.00', '1.00', '1.00', '1.00', '1.00', '1.00', '1.00', '1.00', '1.00', '1.00', '1.00', '1.00', '1.00', '1.00', '1.00', '1.00', '1.00'),
(2, '1', '1.00', '1.00', '1.00', '1.00', '1.00', '1.00', '1.00', '1.00', '1.00', '1.00', '1.00', '1.00', '1.00', '1.00', '1.00', '1.00', '1.00', '1.00', '1.00', '1.00'),
(3, '2', '2.00', '2.00', '2.00', '2.00', '2.00', '2.00', '2.00', '2.00', '2.00', '2.00', '2.00', '2.00', '2.00', '2.00', '2.00', '2.00', '2.00', '2.00', '2.00', '2.00'),
(4, '3', '3.00', '3.00', '3.00', '3.00', '3.00', '3.00', '3.00', '3.00', '3.00', '3.00', '3.00', '3.00', '3.00', '3.00', '3.00', '3.00', '3.00', '3.00', '3.00', '3.00'),
(5, '4', '4.00', '4.00', '4.00', '4.00', '4.00', '4.00', '4.00', '4.00', '4.00', '4.00', '4.00', '4.00', '4.00', '4.00', '4.00', '4.00', '4.00', '4.00', '4.00', '4.00');
...
(0, 'admin@admin.com', 'Admin', 'Admin', 0, 't-0'),
...
(3, 'martin@edu.madrid.org', 'Martin', '1234', 2, 't-3');
COMMIT;
